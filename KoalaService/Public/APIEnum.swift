...
public enum APIEnum :Int{
    ...
    //这是考拉报警的
	static let BasePublicBaseUrl = ""
//	static let BaseBaseUrl = ""
	
    //这是中行的
	static let BaseBaseUrl = ""
//	static let BaseBaseInternalUrl = ""
	
    //专门用于模拟发布的
	static let BaseDemoUrl = ""
...
(APIEnum.GetSecurityInfoList,"App_Get_SecurityInfoList","GetSecurityInfoList"),
(APIEnum.GetCommentCoolReadCount,"App_Get_Comment_Cool_Read_Count","GetCommentCoolReadCount"),
